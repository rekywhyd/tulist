        ...
        <div class="flex flex-col min-h-screen">
            <header class="flex font-poppins items-center justify-between w-full pt-14 bg-[#E8EEF9]">
                ...
                <div class="flex items-center gap-10 mr-8">
                    <div class="relative">
                        <input type="text" placeholder="Search" class="w-[180px] py-2 pl-16 pr-4 border-white bg-white rounded-3xl focus:outline-none focus:ring-2 focus:ring-blue-500">
