<aside class="fixed z-10 flex flex-col items-center h-screen pb-2 pl-6 pt-28 w-fit">
  ...
  <nav class="flex flex-col items-center justify-between h-full">
    ...
    <div class="flex flex-col gap-2 border border-white w-fit bg-white/30 backdrop-blur-3xl rounded-3xl">
      {{-- NOTIF --}}
      <a href="" title="Notifications" class="p-3 transition-colors rounded-full duration-200 hover:hover:scale-110 {{ request()->routeIs('notifications') 
          ? 'bg-[#0E213D] text-[#D5E2F5]' 
          : 'text-[#717C8F] hover:bg-[#0E213D] hover:text-[#D5E2F5]' }}">
      ...
      {{-- SETTING --}}
      <a href="{{ route('profile.edit') }}" class="p-3 transition-colors rounded-full duration-200 hover:hover:scale-110 {{ request()->routeIs('profile.edit') 
          ? 'bg-[#0E213D] text-[#D5E2F5]' 
          : 'text-[#717C8F] hover:bg-[#0E213D] hover:text-[#D5E2F5]' }}" title="Setting">
    ...
    {{-- KOLOM 3 --}}
        <div class="flex flex-col gap-2 border border-white bg-white/30 backdrop-blur-3xl w-fit rounded-3xl">
          ...
          <form method="POST" action="{{ route('logout') }}">
            @csrf
            <a href="{{ route('logout') }}" title="Log Out" onclick="event.preventDefault(); this.closest('form').submit();" class="block p-3 transition-colors rounded-full duration-200 hover:hover:scale-110 {{ request()->routeIs('logout') 
              ? 'bg-red-600 text-white' 
              : 'text-[#717C8F] hover:bg-red-600 hover:text-white' }}">
