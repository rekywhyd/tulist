<x-app-layout>
    <div class="min-h-full items-center mr-8 ml-20 py-6 border-white shadow-md bg-white/50 rounded-[40px]">
                    ...
                    @foreach($todayTasks as $task)
                        <div class="mb-2" data-original-due-date="{{ $task->due_date ? $task->due_date->format('Y-m-d') : '' }}">
                            <div class="flex items-center ml-4">
                                ...
                                <span class="{{ $task->completed ? 'line-through text-gray-500' : '' }} ml-4 flex-1">{{ $task->title }}</span>
                                @if($task->subtasks->count() > 0)
                                    <button class="ml-2 text-gray-500 subtask-toggle" data-task="{{ $task->id }}">                               
                                        <svg class="w-6 h-6 transition-transform duration-200 subtask-arrow hover:hover:scale-110" fill="#6b7280" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M15 10l-9 5V5l9 5z"></path></g></svg>                                      
                                    </button>
                                @endif
                                <div class="relative ml-2">
                                    <button class="text-gray-500 task-menu-btn hover:text-gray-700" data-task="{{ $task->id }}">
                                        <svg class="w-3 h-3 transition-transform duration-200 hover:hover:scale-110" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M19 16a3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3zm0 13a3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3zm0-26a3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3z" fill="#6b7280"></path></g></svg>
                                    </button>
                                    <div class="absolute right-0 z-10 hidden w-48 mt-1 shadow-xl rounded-xl bg-[#0C1F3B] task-menu" data-task="{{ $task->id }}">
                                        <button class="flex items-center w-full gap-2 px-4 py-2 text-sm font-medium text-left text-white shadow-xl rounded-xl hover:bg-gray-600 details-btn" data-task="{{ $task->id }}">
                                            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M3 9C2.44772 9 2 9.44772 2 10C2 10.5523 2.44772 11 3 11H21C21.5523 11 22 10.5523 22 10C22 9.44772 21.5523 9 21 9H3Z" fill="#FFFFFF"></path> <path d="M3 13C2.44772 13 2 13.4477 2 14C2 14.5523 2.44772 15 3 15H15C15.5523 15 16 14.5523 16 14C16 13.4477 15.5523 13 15 13H3Z" fill="#FFFFFF"></path> </g></svg>
                                            Details</button>
                                        <button class="flex items-center w-full gap-3 px-3 py-2 text-sm font-medium text-left text-white shadow-xl rounded-xl hover:bg-gray-600 rename-btn" data-task="{{ $task->id }}">
                                            <svg class="w-6 h-6" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M11.75 2C11.3358 2 11 2.33579 11 2.75C11 3.16421 11.3358 3.5 11.75 3.5H13.25V24.5H11.75C11.3358 24.5 11 24.8358 11 25.25C11 25.6642 11.3358 26 11.75 26H16.25C16.6642 26 17 25.6642 17 25.25C17 24.8358 16.6642 24.5 16.25 24.5H14.75V3.5H16.25C16.6642 3.5 17 3.16421 17 2.75C17 2.33579 16.6642 2 16.25 2H11.75Z" fill="#FFFFFF"></path> <path d="M6.25 6.01958H12.25V7.51958H6.25C5.2835 7.51958 4.5 8.30308 4.5 9.26958V18.7696C4.5 19.7361 5.2835 20.5196 6.25 20.5196H12.25V22.0196H6.25C4.45507 22.0196 3 20.5645 3 18.7696V9.26958C3 7.47465 4.45507 6.01958 6.25 6.01958Z" fill="#FFFFFF"></path> <path d="M21.75 20.5196H15.75V22.0196H21.75C23.5449 22.0196 25 20.5645 25 18.7696V9.26958C25 7.47465 23.5449 6.01958 21.75 6.01958H15.75V7.51958H21.75C22.7165 7.51958 23.5 8.30308 23.5 9.26958V18.7696C23.5 19.7361 22.7165 20.5196 21.75 20.5196Z" fill="#FFFFFF"></path> </g></svg>
                                            Rename</button>
                                        <button class="flex items-center w-full gap-3 px-3 py-2 text-sm font-medium text-left text-white shadow-xl rounded-xl hover:bg-gray-600 duplicate-btn" data-task="{{ $task->id }}">
                                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="matrix(-1, 0, 0, 1, 0, 0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M18 3H4C3.44772 3 3 3.44772 3 4V18C3 18.5523 2.55228 19 2 19C1.44772 19 1 18.5523 1 18V4C1 2.34315 2.34315 1 4 1H18C18.5523 1 19 1.44772 19 2C19 2.55228 18.5523 3 18 3Z" fill="#FFFFFF"></path> <path d="M13 11C13 10.4477 13.4477 10 14 10C14.5523 10 15 10.4477 15 11V13H17C17.5523 13 18 13.4477 18 14C18 14.5523 17.5523 15 17 15H15V17C15 17.5523 14.5523 18 14 18C13.4477 18 13 17.5523 13 17V15H11C10.4477 15 10 14.5523 10 14C10 13.4477 10.4477 13 11 13H13V11Z" fill="#FFFFFF"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M20 5C21.6569 5 23 6.34315 23 8V20C23 21.6569 21.6569 23 20 23H8C6.34315 23 5 21.6569 5 20V8C5 6.34315 6.34315 5 8 5H20ZM20 7C20.5523 7 21 7.44772 21 8V20C21 20.5523 20.5523 21 20 21H8C7.44772 21 7 20.5523 7 20V8C7 7.44772 7.44772 7 8 7H20Z" fill="#FFFFFF"></path> </g></svg>
                                            Duplicate</button>
                                        <button class="flex items-center w-full gap-3 px-3 py-2 text-sm font-medium text-left text-white shadow-xl rounded-xl hover:bg-gray-600 add-subtask-btn" data-task="{{ $task->id }}">
                                            ...
                                            Add Subtask</button>
                                        <button class="flex items-center w-full gap-3 px-2 py-2 text-sm font-medium text-left text-red-500 shadow-xl rounded-xl hover:bg-gray-600 delete-btn" data-task="{{ $task->id }}">
                                            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 5H18M9 5V5C10.5769 3.16026 13.4231 3.16026 15 5V5M9 20H15C16.1046 20 17 19.1046 17 18V9C17 8.44772 16.5523 8 16 8H8C7.44772 8 7 8.44772 7 9V18C7 19.1046 7.89543 20 9 20Z" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                            Delete</button>
                                    </div>
                                </div>
                            </div>
                            <div class="hidden ml-14 subtasks" id="subtasks-{{ $task->id }}">
                                @foreach($task->subtasks as $subtask)
                                    <div class="mb-1 subtask-item {{ $subtask->completed ? 'opacity-50' : '' }}">
                                        <input type="checkbox" class="w-4 h-4 rounded-full subtask-checkbox accent-blue-500" data-id="{{ $subtask->id }}" {{ $subtask->completed ? 'checked' : '' }}>
    ...
    <div id="add-task-modal" class="fixed inset-0 z-50 hidden w-full h-full overflow-y-auto bg-gray-600 font-poppins bg-opacity-80">
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-5 bg-[#132C51] shadow-xl rounded-xl w-[600px]">
            <div class="mt-3">
                <h3 class="mb-8 text-2xl font-semibold text-white">New Task</h3>
                <form action="{{ route('tasks.store') }}" method="POST">
                    @csrf
                    <div class="mb-5">
                        <input placeholder="Title Name" type="text" name="title" class="w-full px-3 py-2 border text-white border-gray-600 bg-[#0C1F3B] rounded-lg" required>
                    </div>
                    <div class="mb-4">
                        <textarea placeholder="Add Description" name="description" class="w-full bg-[#0C1F3B] px-3 text-white py-2 border-gray-600 border rounded-lg"></textarea>
                    </div>
                    ...
                    <div class="flex flex-wrap justify-center gap-2 mb-5">
                        ...
                        {{-- DATE --}}
                        <input type="date" name="due_date" class="w-[49%] text-white bg-[#0C1F3B] border-gray-600 px-3 py-2 border rounded-lg [color-scheme:dark]" required value="{{ date('Y-m-d') }}">
    ...
    <div id="confirm-modal" class="fixed inset-0 z-50 hidden w-full h-full overflow-y-auto bg-gray-600 bg-opacity-50 font-poppins">
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-5 mx-auto bg-[#132C51] rounded-xl shadow-xl w-[500px]">
            <div class="mt-3 text-center">
                ...
                <div class="flex justify-center gap-6 mt-6 font-medium">
                    <button id="confirm-no" class="px-5 py-1 text-white transition-transform duration-200 bg-gray-500 hover:hover:scale-95 rounded-3xl">No</button>
                    <button id="confirm-yes" class="transition-transform duration-200 hover:hover:scale-110 px-5 py-1 text-white bg-[#1C427A] rounded-3xl">Yes</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="add-subtask-modal" class="fixed inset-0 z-50 hidden w-full h-full overflow-y-auto bg-gray-600 bg-opacity-50 font-poppins">
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-5 mx-auto bg-[#132C51] rounded-xl shadow-xl w-[400px]">
            <div class="mt-3">
                ...
                <form id="add-subtask-form">
                    ...
                    <div class="mb-4">
                        <input type="text" id="subtask-title" class="w-full px-3 py-2 text-white border border-gray-600 rounded-xl mb-2 bg-[#0C1F3B]" required>
                    </div>
                    <div class="flex justify-center gap-6 mt-4 font-medium">
                        <button type="button" id="close-add-subtask-modal" class="px-5 py-1 text-white transition-transform duration-200 bg-gray-500 hover:hover:scale-95 rounded-3xl">Cancel</button>
                        <button type="submit" class="transition-transform duration-200 hover:hover:scale-110 px-5 py-1 text-white bg-[#1C427A] rounded-3xl">Add</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="delete-confirm-modal" class="fixed inset-0 z-50 hidden w-full h-full overflow-y-auto bg-gray-600 bg-opacity-50">
        <div class="absolute p-5 mx-auto -translate-x-1/2 -translate-y-1/2 bg-[#132C51] shadow-xl top-1/2 left-1/2 rounded-xl w-[500px]">
            <div class="mt-3 text-center">
                ...
                <div class="flex justify-center gap-6 mt-6 font-medium">
                    <button id="delete-no" class="px-5 py-1 text-white transition-transform duration-200 bg-gray-500 hover:hover:scale-95 rounded-3xl">No</button>
                    <button id="delete-yes" class="transition-transform duration-200 hover:hover:scale-110 px-5 py-1 text-white bg-[#1C427A] rounded-3xl">Yes</button>
                </div>
            </div>
        </div>
    </div>

    <div id="task-details-modal" class="fixed inset-0 z-50 hidden w-full h-full overflow-y-auto bg-gray-600 bg-opacity-50">
        <div class="absolute p-5 mx-auto -translate-x-1/2 -translate-y-1/2 bg-[#132C51] shadow-xl top-1/2 left-1/2 rounded-xl w-96">
            <div class="mt-3">
                ...
                <div class="flex justify-center mt-6 font-medium">
                    <button type="button" id="close-details-modal" class="px-5 py-1 text-white transition-transform duration-200 bg-gray-500 hover:hover:scale-110 rounded-3xl">Close</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.querySelectorAll('.subtask-toggle').forEach(button => {
            button.addEventListener('click', function() {
                ...
                // 'arrow' sekarang adalah elemen SVG itu sendiri
