...
@section('content')
    ...
    <div class="flex justify-end">
        <button id="edit-profile-btn"
                        ...
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13.5 6.5L17.5 10.5M4 20H8L18.5 9.5L14.5 5.5L4 16V20Z" stroke="currentColor"
    ...
    <div class="px-12 space-y-6 font-poppins">
        ...
        {{-- C. Combined Edit Form Area (Hidden by default, shown when 'Edit' is clicked --}}
        ...
        {{-- D. Combined Edit Form Area (Hidden by default, shown when 'Change Password' is clicked --}}
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const cancelProfileBtn = document.getElementById('cancel-edit-btn'); // Ini adalah tombol cancel untuk edit PROFILE
        const deleteAccountSection = document.getElementById('delete-account-section'); // <--- BARU: Delete Account
        ...
        const cancelPasswordBtn = document.getElementById('cancel-password-btn'); // Tombol Cancel untuk password (ID yang sudah diperbaiki)
        ...
        function toggleProfileEditMode(isEditing) {
            if (isEditing) {
                ...
                // BARU: Sembunyikan Delete Account
        ...
        // Pastikan Anda menggunakan ID BARU 'cancel-password-btn' di sini
